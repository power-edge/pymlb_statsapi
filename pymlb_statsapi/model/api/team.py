...
class TeamModel(EndpointModel):
    ...
    def affiliates(self, **kwargs):
        ...
        raise NotImplementedError(
            """TODO - fix https://beta-statsapi.mlb.com/api/api_docs/stats-api/team affiliates api
    ...
    def allTeams(self, **kwargs):
        ...
        # return self.get_api_file_object(**kwargs)
        raise NotImplementedError(
            """TODO - fix https://beta-statsapi.mlb.com/api/api_docs/stats-api/team allTeams` api
